...
1. Seleccionar e integrar los componentes de hardware del sistema (sensores fisiológicos, microcontrolador, actuador de enfriamiento y etapa de alimentación), justificando técnicamente cada elección.
